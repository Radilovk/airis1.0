...
export function analyseIrisQuality(
  ...
  if (geometry.pupilConfidence < 0.18 || geometry.pupil.r <= 0) {
    ...
    issues.push({
      ...
      level: 'error',
      message: 'Границата на зеницата е неясна.',
      fix: 'Нагласете синия кръг върху зеницата или направете нова, по-рязка снимка.',
    })
    ...
    issues.push({
      ...
      fix: 'Проверете синия кръг. Ако не съвпада със зеницата, нагласете го — от него зависи цялата карта.',
    })
  }
