    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-sm">
          Промптът дирижира процеса на анализ - етапи, брой заявки, структуриране на изхода според очакванията на репорт страницата
        </CardDescription>
        {aiPromptTemplate && (
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-2 md:p-3 bg-muted/50 rounded-lg border border-border">
          <p className="text-xs text-muted-foreground break-words">
            💡 Този промпт ДИРИЖИРА процеса на анализ:
            <br />• Определя етапите на обработка
            <br />• Указва колко заявки да се направят (за избягване на отрязване на информация)
            <br />• Структурира изхода според очакванията на репорт страницата
            <br />
            <br />Използвайте променливите в двойни къдрави скоби {'{{variable}}'} за динамично попълване на данни.
          </p>
        </div>
      </CardContent>
    </Card>
