          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground ml-7">
                Ръководството се използва САМО за установяване на находките (топография + тип) и тяхното диагностично значение - с кои органи/системи са свързани
              </p>
              <Slider
                value={[manualWeight]}
            ...
            >
              ...
              <p className="text-xs text-muted-foreground ml-7">
                Промптът дирижира процеса, етапите, според броя заявки и извежда получената информация според очакванията на репорт страницата
              </p>
              <Slider
                value={[promptWeight]}
            ...
            >
              ...
              <p className="text-xs text-muted-foreground ml-7">
                LLM знанията се използват за това как се разчитат и корелират находките спрямо цялата информация за клиента
              </p>
              <Slider
      ...
      <Card className="bg-muted/30">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs mt-1">
                  Ръководството се използва ЕДИНСТВЕНО за установяване на находките в ириса - изключително важно 
                  да бъде определено топографски (коя зона) и като вид находка (лакуни, крипти, пигменти и т.н.). 
                  След това, пак чрез ръководството, се определя какво значи диагностично и с кои органи/системи са свързани.
                </p>
                <p className="text-xs mt-1 italic">
                  💡 По-високо тегло → По-голям фокус върху точното установяване и картиране на находките
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs mt-1">
                  LLM знанията и интернет търсенето са свързани с това КАК се разчитат и корелират находките 
                  спрямо ЦЯЛАТА информация, която имаме за клиента - данни от въпросника, анамнеза, симптоми, 
                  начин на живот. Предоставя контекст за интерпретация и препоръки.
                </p>
                <p className="text-xs mt-1 italic">
                  💡 По-високо тегло → По-задълбочена корелация и интерпретация на находките в контекста на пациента
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs mt-1">
                  Експериментална функция за динамично търсене на най-актуална информация. Също се използва за 
                  корелация на находките с актуални медицински изследвания и информация.
                  Забележка: Може да забави анализа значително и не е винаги налична.
                </p>
                <p className="text-xs mt-1 italic">
                  ⚠️ Понастоящем НЕ Е АКТИВНА в API
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-primary/5 p-3 rounded-lg border border-primary/20">
            <h4 className="text-sm font-semibold text-foreground mb-2">🔬 Как работи анализът с различните източници?</h4>
            <div className="space-y-2 text-xs">
              <p>
                <strong>1. Визуален анализ и установяване на находки (Manual {manualWeight}%):</strong> AI моделът анализира 
                изображенията и използва Иридологичното ръководство за да установи находките - определя ги топографски 
                (в коя зона са) и като тип (лакуни, крипти, пигменти и т.н.). Това е критичният етап на точно картиране.
              </p>
              <p>
                <strong>2. Диагностично значение (Manual {manualWeight}%):</strong> Пак чрез ръководството се определя 
                какво означават находките диагностично, с кои органи/системи са свързани и към какво ни насочват.
              </p>
              <p>
                <strong>3. Корелация и интерпретация (LLM {llmKnowledgeWeight}% + Web {webSearchWeight}%):</strong> 
                LLM знанията и интернет търсенето се използват за това КАК да се разчетат и корелират находките 
                спрямо ЦЯЛАТА информация за клиента - въпросник, симптоми, анамнеза, начин на живот.
              </p>
              <p>
                <strong>4. Структуриране на резултата (Prompt {promptWeight}%):</strong> Промптът дирижира процеса, 
                определя етапите според броя заявки и извежда информацията според очакванията на репорт страницата.
              </p>
            </div>
          </div>
          ...
          <div className="bg-accent/5 p-3 rounded-lg border border-accent/20">
            ...
            <div className="space-y-3 text-xs">
              <div>
                <strong className="text-accent">Консервативна (фокус върху точно установяване):</strong>
                <div className="mt-1 space-y-1">
                  <div>• Ръководство: 60% - Максимален фокус върху точна топография и установяване на находки</div>
                  <div>• Prompt: 25% - Структурирано представяне</div>
                  <div>• LLM: 15% - Минимална корелация с допълнителни данни</div>
                  <div className="text-muted-foreground italic">→ Подходяща за строга иридологична диагностика</div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1 space-y-1">
                  <div>• Ръководство: 40% - Солидна база за установяване на находки</div>
                  <div>• Prompt: 30% - Добро структуриране на процеса</div>
                  <div>• LLM: 25% - Балансирана корелация с пациентски данни</div>
                  <div>• Търсене: 5% - Допълнителна актуална информация (ако е активно)</div>
                  <div className="text-muted-foreground italic">→ Най-добър компромис за повечето случаи</div>
                </div>
              </div>

              <div>
                <strong className="text-yellow-600">Холистична (фокус върху корелация):</strong>
                <div className="mt-1 space-y-1">
                  <div>• Ръководство: 25% - База за установяване на находки</div>
                  <div>• Prompt: 30% - Силно структуриране</div>
                  <div>• LLM: 40% - Максимална корелация и интерпретация</div>
                  <div>• Търсене: 5% - Допълнителна информация</div>
                  <div className="text-muted-foreground italic">→ За пациенти с много допълнителни данни и нужда от корелация</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <Alert>
            ...
            <AlertDescription className="text-xs">
              <strong>Важно:</strong> Настройките на стратегията влияят на ЦЕЛИЯ процес на анализ:
              <br/>• Ръководството определя топографията и типа на находките
              <br/>• LLM знанията корелират находките с пациентските данни
              <br/>• Промптът структурира и дирижира процеса
              <br/>Експериментирайте с различни настройки за да намерите баланса, който най-добре отговаря на вашата практика.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
