...
- Върни празен масив [] САМО ако изображението е НАИСТИНА перфектно чисто
- По-добре да докладваш находка с severity:"low", отколкото да я пропуснеш
- Ако виждаш тъмно петно, промяна в цвета, вдлъбнатина, линия - това Е артефакт
- Малки находки също са важни - докладвай ги като severity:"low"
- Ако има съмнение - докладвай го! Превантивният подход е по-добър
