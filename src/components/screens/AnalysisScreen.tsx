...
- Бъди ВНИМАТЕЛЕН и ПРЕВАНТИВЕН: Включи всички находки, дори малки, съмнителни или слабо изразени
- Ако виждаш нещо съмнително, ЗАДЪЛЖИТЕЛНО го отбележи със status:"attention" - по-добре да включиш съмнителна находка, отколкото да я пропуснеш
- Маркирай със status:"concern" само ясно видими и сигурни находки
- Използвай status:"normal" само ако зоната е визуално чиста и хомогенна БЕЗ находки
...
1. ЯСНА ВИДИМА НАХОДКА + СЪОТВЕТЕН СИМПТОМ → status:"concern", priority:high (активен проблем)
2. ВИДИМА НАХОДКА БЕЗ СИМПТОМ → status:"attention", priority:medium (латентна слабост)  
3. СЪМНИТЕЛНА/СЛАБА НАХОДКА → status:"attention", priority:low (превантивно отбелязване)
4. НЯМА НАХОДКА НО ИМА СИМПТОМ → status:"attention", priority:low, findings: "Визуално чиста зона, но присъства симптом" (препоръчай допълнителна диагностика)
5. ВИЗУАЛНО ЧИСТА ЗОНА + НЯМА СИМПТОМ → status:"normal"
